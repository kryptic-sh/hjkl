...
[buffr](https://github.com/kryptic-sh/buffr), and a future standalone
hjkl binary.

## Status

**Pre-release.** 0.0.0 placeholders are published to crates.io to reserve
names. No public API yet. See [MIGRATION.md](MIGRATION.md) for the full
extraction plan and design rationale.
