# Contributing to `hjkl-editor-tui`

Thanks for considering a contribution. `hjkl-editor-tui` is pre-1.0 and the
...
```bash
git clone git@github.com:kryptic-sh/hjkl-editor-tui.git
cd hjkl-editor-tui
