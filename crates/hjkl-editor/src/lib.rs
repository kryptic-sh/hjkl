...
pub mod spec {
    ...
    pub use hjkl_engine::types::{
        Attrs, Color, CursorShape, Edit, EngineError, Highlight, HighlightKind, Host, Input, Mode,
        Modifiers, MouseEvent, MouseKind, Options, Pos, Selection, SelectionKind, SelectionSet,
        SpecialKey, Style,
    };
}
