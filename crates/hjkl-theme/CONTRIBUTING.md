# Contributing to `hjkl-theme`

Thanks for considering a contribution. `hjkl-theme` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/hjkl-theme.git
cd hjkl-theme
