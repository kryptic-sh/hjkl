...
// Named RGB constants used by branch/commit/status decoration. Inlined here
// so the crate stays host-agnostic (no ratatui dep).
const YELLOW: EngineColor = EngineColor(255, 215, 0);
const MAGENTA: EngineColor = EngineColor(255, 0, 255);
const CYAN: EngineColor = EngineColor(0, 255, 255);
const GREEN: EngineColor = EngineColor(0, 205, 0);
