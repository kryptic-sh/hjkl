...
pub use folds::injected_parse_counter;
pub use folds::{
    DEFAULT_FOLD_MARKER_CLOSE, DEFAULT_FOLD_MARKER_OPEN, DEFAULT_REGION_MARKER_CLOSE,
    DEFAULT_REGION_MARKER_OPEN, InjectedFoldCache, builtin_folds, extract_fold_ranges,
    extract_fold_ranges_rope, extract_fold_ranges_rope_with_injections,
