# Contributing to `hjkl-splash`

Thanks for considering a contribution. `hjkl-splash` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/hjkl-splash.git
cd hjkl-splash
...
`0.x`. Inter-crate sibling deps in this family use caret (`"0.1"`) and ship with
