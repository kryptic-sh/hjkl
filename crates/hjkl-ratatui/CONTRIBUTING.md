# Contributing to `hjkl-ratatui`

Thanks for considering a contribution. `hjkl-ratatui` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/hjkl-ratatui.git
cd hjkl-ratatui
