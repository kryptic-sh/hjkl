# Contributing to `hjkl-anvil`

Thanks for considering a contribution. `hjkl-anvil` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/hjkl-anvil.git
cd hjkl-anvil
