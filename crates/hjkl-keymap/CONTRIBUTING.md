# Contributing to `hjkl-keymap`

Thanks for considering a contribution. `hjkl-keymap` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/hjkl-keymap.git
cd hjkl-keymap
