...
[![CI](https://github.com/kryptic-sh/hjkl-picker/actions/workflows/ci.yml/badge.svg)](https://github.com/kryptic-sh/hjkl-picker/actions/workflows/ci.yml)
...
Stable public API. `PickerLogic` is the extension point for custom sources; the
trait is unlikely to gain mandatory methods without a major bump.
