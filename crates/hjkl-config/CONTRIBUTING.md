# Contributing to `hjkl-config`

Thanks for considering a contribution. `hjkl-config` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/hjkl-config.git
cd hjkl-config
